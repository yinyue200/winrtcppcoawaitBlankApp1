...
HRESULT __stdcall WINRT_GetActivationFactory(HSTRING classId, void** factory)
{
    try
    {
        *factory = nullptr;
        ...
        if (0 == wcscmp(name, L"winrtcppcoawaitBlankApp1.MainPage"))
        {
            *factory = winrt::detach_abi(winrt::make<winrt::winrtcppcoawaitBlankApp1::factory_implementation::MainPage>());
            return S_OK;
        }
